...
const Contact = () => {
  ...
  return (
    <>
      <section className="py-20 lg:py-[120px] overflow-hidden relative z-10 mt-[40px]">
          ...
          <div className="flex flex-wrap items-center justify-center gap-10">
            <div className="mx-4 md:mx-0">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <h2 className="mb-6 text-[32px] font-bold font-oswald uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  GET IN TOUCH WITH US
                </h2>
                <p className="text-base leading-relaxed mb-9 text-body-color">
                Discover beautiful jewelry that tells a special story.Find the perfect piece to express your unique taste and elevate your look with a touch of luxury.
                </p>
                ...
                <div className="mb-6">
                  ...
                  <p className={isSubmit?"text-center text-green-500":'hidden'}>Form Data Submit Successfully!</p>
                    <button
                      ...
                      className="w-full p-3 text-black transition border rounded border-primary bg-primary hover:bg-black hover:bg-opacity-50"
                    >
                      Send Message
                    </button>
                  </div>
