        ...
        <>
            <div className="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
                <div className="container max-w-screen-lg mx-auto">
                                ...
                                <div className="lg:col-span-2">
                                    <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                        <div className="md:col-span-5">
                                            ...
                                            <input type="text" name="full_name" id="full_name" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" defaultValue />
                                        </div>
                                        <div className="md:col-span-5">
                    ...
                    <a href="https://www.buymeacoffee.com/dgauderman" target="_blank" rel="noopener noreferrer" className="md:absolute bottom-0 right-0 p-4 float-right">
