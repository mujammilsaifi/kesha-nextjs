...
const handleCreateSlide = async () => {
  ...
  try {
    const {data} = await axios.post('/api/addslider', formDataToSend,{headers:{Authorization:token }});
    if (data?.success) {
      toast.success(data?.message);
      setTopLoading(100)
    } else {
...
// -------------------mobile responsive------------------------
  ...
  return (
    ...
    <aside id="default-sidebar"  className={toggle?"fixed h-[100%] z-40 top-[130px] left-0  w-63 transition-transform -translate-x-full sm:translate-x-0":"fixed z-40 top-[100px]  left-0  w-63 transition-transform  sm:translate-x-0"} aria-label="Sidebar">
